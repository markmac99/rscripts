...
# Observations recorded by `r SelectStation`, `r Oper_since_yr` to `r Oper_to_yr`
...
`r if (fireball_count) {"Fireballs recorded (Based on IAU definition of apparrent magnitude of -4.0 of greater)"}`
